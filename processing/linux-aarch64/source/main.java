/* autogenerated by Processing revision 1294 on 2025-01-29 */
...
//motor1
  Knob1 = cp5.addKnob("motor1")  // "method" is add(ControllerInterface<?> theElement) 
               ...
               .setLabel("Rotation [°]")
               .setScrollSensitivity(1/(1.350f*200))
...
public void push1() {
  int push = Math.round(Knob1.getValue()) + PApplet.parseInt(cp5.getController("int1").getValue());
  Knob1.setValue(push);
...
public void push2() {
  int push = Math.round(Knob1.getValue()) + PApplet.parseInt(cp5.getController("int2").getValue());
  Knob1.setValue(push);
  push = push - recentValue;
  if( push >= 0) {write(push, 0, 7);}
  if( push < 0) {write(push, 0, 6);} 
...
public int getMostRecentMotor1Value(String folderPath) {
